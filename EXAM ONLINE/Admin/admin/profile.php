...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      .
      <ol class="breadcrumb">
        <li><a href="./"><i class="fa fa-dashboard"></i> Home pages</a></li>
        <li class="active">Information of account</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
            ...
            <div class="box-body box-profile">
             ...
             if ($result->num_rows > 0) {
              ...
              while($row = $result->fetch_assoc()) {
               ...
               echo '<img src="data:image/jpeg;base64,'.base64_encode($row['img_dd'] ).'" class="profile-user-img img-responsive img-circle" alt="'.$current_user.'" title="'.$current_user.'"/>';
             }
           }
         } else {
        ...
        <form action="update_avt.php" method="POST" enctype="multipart/form-data">
         ...
         <button type="submit" class="pull-right btn btn-default" name="uplogo" id="sendEmail">UPLOAD <i class="fa fa-arrow-circle-up"></i></button>
       </form>
     </div>
     <!-- /.box-body -->
   </div>
...
<div class="box-footer clearfix">
  <button type="submit" class="pull-right btn btn-default" name="upschool" id="sendEmail">SAVE</button>
</div>
</form>
</div>
